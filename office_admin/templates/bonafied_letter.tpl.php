...
/************ Get List of Districts ***********/
		...
		{   
			...
			url="?pid=117&action=getposts&es_departmentsid="+countryid+"&selval="+selval;
		...
		{   
			...
			url="?pid=117&action=getstaff&cid="+countryid+"&selval="+getselected;
			url=url+"&sid="+Math.random();
...
<?php echo $html_obj->draw_hiddenfield('copyid',$copyid);?><?php */?>
			...
			<td width="1%" align="center"><strong> :</strong></td>
					<td width="64%" height="30" align="left"><input type="text" name="sno1" value="<?php if($action=='edit'){
                                 echo $sem_det['id']; } else {   $max_id=$db->getRow("SELECT MAX(id) as max_id FROM es_bonafied");
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
         ...
         <td height="3" colspan="3"></td>
              ...
              <tr>
                <td height="25" colspan="3" class="bgcolor_02">&nbsp;&nbsp;<span class="admin">Bonafied Certificate</span></td>
  </tr>			  
              <tr>
                <td width="1" class="bgcolor_02"></td>
                <td  align="center" valign="top">
				<table width="100%" border="0">
				  ...
				  <tr>
					...
					<table width="100%" border="0">
						<tr>
						<td colspan="7" align="right" height="25" style="padding-right:20px;"><a href="?pid=117&action=add" class="bgcolor_02" style="padding:5px; text-decoration:none; color:#333333">Add New</a></td>
					  </tr>
					  <tr><td>&nbsp;</td></tr>
					 ...
					 ?>
					  ...
					  <tr>
						...
						<td align="left" valign="middle">&nbsp;<?php echo $eachrecord['father_name']; ?></td>
							...
							<a href="javascript:void(0)" onclick="popup_letter('?pid=117&action=print_bonafiedcertificate&id=<?php echo $eachrecord['id']; ?>')" ><img src="images/print_16.png" border="0" title="View" alt="View" /></a>
							
							
							&nbsp;<a href="?pid=117&action=edit&id=<?php echo $eachrecord['id']; ?>" ><img src="images/b_edit.png" border="0" title="Edit" alt="Edit" /></a>
                            <?php ?>&nbsp;<a href="?pid=117&action=delete&id=<?php echo $eachrecord['id']; ?>" onClick="return confirm('Are you sure want to delete ?')"><img src="images/b_drop.png" border="0" title="Delete" alt="Delete" /></a><?php ?></td>
...
<?php }?>
<?php if($action=='print_bonafiedcertificate'){ 
								...
								<td  align="center" valign="top"><table width="100%" border="0">
								  <tr>
								    <td height="30" colspan="4" align="left" valign="top" ><table width="100%" border="0" cellpadding="0" cellspacing="2" style="font-family:Verdana, Arial, Helvetica, sans-serif; font-size:14px; font-weight:500; line-height:25px;">
								      <tr>
								        <td width="7105%" colspan="7"><table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
								          <tr>
								            <td colspan="7" align="center" valign="top" style="font-family:Verdana, Arial, Helvetica, sans-serif; font-size:17px; color:#000000; text-decoration:underline; padding:8px; font-weight:bold;"><p>This Feature Available at  Full Version at <a href="http://pro.arox.in" target="_blank">pro.arox.in</a> </p></td>
							              </tr>
								          <!-- <tr>
                                            <td width="28%" height="30" align="left" valign="bottom" style="font-family:Verdana, Arial, Helvetica, sans-serif; font-size:12px; color:#000000;">This is to certify that</td>
                                          ...
                                          <tr>
                                            <td height="30" colspan="4" align="left" valign="bottom"><table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
                                                <tr>
                                                  <td width="25%" height="30" align="left" valign="bottom" style="font-family:Verdana, Arial, Helvetica, sans-serif; font-size:12px; color:#000000;">Son/daughter of Shri  </td>
                                                  <td width="25%" align="left" valign="bottom" style="border-bottom:#999999 dotted 1px; font-family:Verdana, Arial, Helvetica, sans-serif; font-size:13px; color:#000000; font-weight:bold;"><?php echo ucwords($candidate_det['father_name']); ?></td>
                                                  <td width="50%" align="left" valign="bottom" style="font-family:Verdana, Arial, Helvetica, sans-serif; font-size:12px; color:#000000;">&nbsp;&nbsp;&nbsp;&nbsp;is a bonafide Student of this school during </td>
                                                </tr>
                                            </table></td>
                                          </tr>
                                          <tr>
                                            <td height="30" colspan="4" align="left" valign="bottom"><table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
                                                <tr>
												<td width="7%" align="left" valign="bottom" style="font-family:Verdana, Arial, Helvetica, sans-serif; font-size:12px; color:#000000;">year</td>
												<td width="16%" align="left" valign="bottom" style="border-bottom:#999999 dotted 1px; font-family:Verdana, Arial, Helvetica, sans-serif; font-size:13px; color:#000000; font-weight:bold;">&nbsp;</td>
                                                  <td width="34%" height="30" align="left" valign="bottom" style="font-family:Verdana, Arial, Helvetica, sans-serif; font-size:12px; color:#000000;">&nbsp;&nbsp;&nbsp;He/She studying in class 
                                                  <td width="43%" align="left" valign="bottom" style="border-bottom:#999999 dotted 1px; font-family:Verdana, Arial, Helvetica, sans-serif; font-size:13px; color:#000000; font-weight:bold;"><?php echo $candidate_det['section']; ?></td>
                                                </tr>-->
								          <!-- bonafied Certificate-->
								          <tr>
								            <td width="28%" height="30" align="left" valign="bottom" style="font-family:Verdana, Arial, Helvetica, sans-serif; font-size:12px; color:#000000;">This is to certify that</td>
								            <td colspan="3" align="left" valign="bottom" style="border-bottom:#999999 dotted 1px; font-family:Verdana, Arial, Helvetica, sans-serif; font-size:13px; color:#000000; font-weight:bold;">&nbsp;&nbsp;Student Name</td>
							              </tr>
								          <tr>
								            <td height="30" colspan="4" align="left" valign="bottom"><table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
								              <tr>
								                <td width="16%" height="30" align="left" valign="bottom" style="font-family:Verdana, Arial, Helvetica, sans-serif; font-size:12px; color:#000000;">S/o/D/o Mr. </td>
								                <td width="34%" align="left" valign="bottom" style="border-bottom:#999999 dotted 1px; font-family:Verdana, Arial, Helvetica, sans-serif; font-size:13px; color:#000000; font-weight:bold;">Father's Name</td>
								                <td width="50%" align="left" valign="bottom" style="font-family:Verdana, Arial, Helvetica, sans-serif; font-size:12px; color:#000000;">&nbsp;&nbsp;&nbsp;&nbsp;is a a bonafide Student of B.Tech./MBA/MCA </td>
							                  </tr>
								              </table></td>
							              </tr>
								          <tr>
								            <td height="30" colspan="4" align="left" valign="bottom"><table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
								              <tr>
								                <td width="29%" align="left" valign="bottom" style="border-bottom:#999999 dotted 1px; font-family:Verdana, Arial, Helvetica, sans-serif; font-size:13px; color:#000000; font-weight:bold;">Academic Year Here</td>
								                <td width="33%" height="30" align="left" valign="bottom" style="font-family:Verdana, Arial, Helvetica, sans-serif; font-size:12px; color:#000000;">&nbsp;&nbsp;&nbsp;&nbsp;Class / Section </td>
								                <td width="38%" align="left" valign="bottom" style="border-bottom:#999999 dotted 1px; font-family:Verdana, Arial, Helvetica, sans-serif; font-size:13px; color:#000000; font-weight:bold;">Class</td>
							                  </tr>
								              </table></td>
							              </tr>
								          <tr>
								            <td colspan="4" align="left" valign="bottom"><table width="100%" border="0" cellspacing="0" cellpadding="0">
								              <tr>
								                <td width="67%" height="34" align="left" valign="bottom" style="font-family:Verdana, Arial, Helvetica, sans-serif; font-size:12px; color:#000000;"> .... Institute, &nbsp;Dhoolkot, &nbsp;Dehradun&nbsp;&nbsp;(Uttarakhand) &nbsp;&nbsp;&nbsp;(Approved by AICTE, Ministry of HRD, </td>
							                  </tr>
								              </table></td>
							              </tr>
								          <tr>
								          ...
								          <tr>
								            <td colspan="4" align="left" valign="top"><table width="53%" border="0" cellspacing="0" cellpadding="0">
								              <tr>
								                ...
								                <td width="65%" align="left" valign="bottom" style="border-bottom:#999999 dotted 1px; font-family:Verdana, Arial, Helvetica, sans-serif; font-size:13px; color:#000000; font-weight:bold;">Year Here</td>
							                  </tr>
								              </table></td>
								            <!-- bonafied Certificate-->
							              </tr>
								      ...
								      <tr>
								        <td height="30" colspan="7" align="left" valign="bottom">&nbsp;</td>
							          </tr>
								      <tr>
								        <td width="28%" height="30" align="left" valign="bottom" style="font-family:Verdana, Arial, Helvetica, sans-serif; font-size:12px; color:#000000;">&nbsp;</td>
								        <td width="14%" align="left" valign="bottom" style="font-family:Verdana, Arial, Helvetica, sans-serif; font-size:12px; color:#000000;">&nbsp;</td>
								        <td width="4%" align="left" valign="bottom" style="font-family:Verdana, Arial, Helvetica, sans-serif; font-size:12px; color:#000000;">&nbsp;</td>
								        <td width="54%" align="left" valign="bottom" style="font-family:Verdana, Arial, Helvetica, sans-serif; font-size:12px; color:#000000;">&nbsp;</td>
								        <td width="0%" align="left" valign="bottom" style="font-family:Verdana, Arial, Helvetica, sans-serif; font-size:12px; color:#000000;">&nbsp;</td>
							          </tr>
								      <tr>
								  ...
								  <tr>
								    <td colspan="10"><table width="100%" border="0" >
								      <tr>
								        <td height="30" align="left" class="narmal"><p>&nbsp;</p></td>
							          </tr>
								      <tr>
								        <td width="34%" height="10" align="left" class="narmal"><strong><em>Registrar</em></strong></td>
							          </tr>
								      <tr>
								        <td height="30" align="left" class="narmal"></td>
							          </tr>
								      <tr>
								        <td height="10" align="left" class="narmal">&nbsp;</td>
							          </tr>
								      </table></td>
							      </tr>
								  </table></td>
