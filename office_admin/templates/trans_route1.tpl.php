...
<?php }?>
				...
				<table width="100%" border="0" cellpadding="1" cellspacing="1" bordercolor="#CCCCCC">
				  <tr  class="bgcolor_02">
					...
					<td width="17%" align="center"><strong>Route Title </strong></td>
					<td width="33%" align="center"><strong>Route </strong></td> 
				  ...
				  <tr class="<?php echo $rowclass;?>">
					...
					<td align="center"><?php echo ucfirst($route['route_title']); ?></td>
					<td align="center">
					 <?php 
						...
						?>
					<?php echo ucfirst($country_row['route_title']); ?>
						</td> 
...
<td align="left" valign="top">
				...
				<table width="100%" border="0" cellpadding="1" cellspacing="1" bordercolor="#CCCCCC">
				  <tr  class="bgcolor_02">
					...
					<td width="22%" align="center"><strong>Route Title </strong></td>
					<td width="47%" align="center"><strong>Route Via </strong></td>  
				  ...
				  <tr class="<?php echo $rowclass;?>">
					...
					<td align="center"> <?php 
						...
						?>
					<?php echo ucfirst($country_row['route_title']); ?><?php 
					
					
					echo ucfirst($route['route_Via']); ?></td>    
					<td align="center"><?php echo $_SESSION['eschools']['currency']."&nbsp;".number_format( $route['amount'], 2, '.', ''); ?></td>   
