...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
        ...
        <?php } ?>
                      ...
                      <tr>
					    ...
					    <tr>
                        <td>&nbsp;</td>
                        <td align="left" valign="middle" class="narmal">Father's Name</td>
                        <td align="left" valign="middle">:</td>
                        <td align="left" valign="middle"><input type="text" name="st_fth" id="st_fth" value="<?php echo $fthname ?>"/></td>
                      </tr>
			...
			$permision_str2[3];
				  ...
				  <script language="javascript" type="text/javascript">
				  	showtable();
                        ...
                        <td align="left" valign="middle">:</td>
                        <td colspan="4" align="left" valign="middle"><input name="st_user" type="text" id="st_user" value="<?php if($st_user!='') echo $st_user; ?>"<?php if($action=='editstaff'){?> <?php } ?>/>
					 ...
					 if($action=='editstaff'){
					  ...
					  <tr>
                        ...
                        <td align="left" valign="middle" class="narmal">Password</td>
                        <td align="left" valign="middle">:</td>
                        <td colspan="4" align="left" valign="middle"><input name="st_password" type="text" id="st_password" value="<?php if($eachrecord1->st_password!='') echo $eachrecord1->st_password; ?>"  /><font color="#FF0000"><b>*</b></font></td>
                      </tr>
					  <?php }?>
                       ...
                       <tr>
                        ...
                        <td align="left" valign="middle" class="narmal">Date Of Birth </td>
						 <td align="left" valign="middle">:</td>
                       	 <td align="left" valign="middle" colspan="4"><input  name="st_dob" id="st_dob" value="<?php  if($eachrecord1->st_dob!='') echo formatDBDateTOCalender($eachrecord1->st_dob);
									 ?>" readonly /><a href="javascript:void(0)" onclick="if(self.gfPop)gfPop.fPopCalendar(document.viewstaff.st_dob);return false;" ><img src="<?php echo JS_PATH ?>/WeekPicker/calbtn.gif" alt="Calender" name="popcal" width="34" height="22" border="0" align="absmiddle" id="popcal" /></a></td>
					 ...
					 <?php }?>
					   <tr>
                        <td>&nbsp;</td>
                        <td align="left" valign="middle" class="narmal">Nationality</td>
                        <td align="left" valign="middle">:</td>
					   ...
					   <tr>
                              ...
                              <td width="2%">&nbsp;</td>
                              <td width="19%"  class="narmal">Information about your family</td>
                              <td width="2%">:</td>
                              <td width="25%"  class="narmal"><textarea name="st_faminfo" id="st_faminfo"><?php 
							  if(isset($eachrecord1->st_faminfo) && $st_faminfo==""){
							  echo $eachrecord1->st_faminfo;}else{echo $st_faminfo;}?></textarea></td>
                              <td width="12%">&nbsp;</td>
                              <td width="22%">&nbsp;</td>
                              <td width="9%">&nbsp;</td>
                              <td width="9%">&nbsp;</td>
							 ...
							 <tr>
                              ...
                              <td width="2%">:</td>
                              <td width="25%"  class="narmal"><textarea name="st_hobbies" id="st_hobbies"><?php 
							  if(isset($eachrecord1->st_hobbies) && $st_hobbies==""){
							  echo $eachrecord1->st_hobbies;}else{echo $st_hobbies;}?></textarea></td>
                              <td width="12%">&nbsp;</td>
                              <td width="22%">&nbsp;</td>
                              <td width="9%">&nbsp;</td>
                              <td width="9%">&nbsp;</td>
					  ...
					  <tr>
                        <td>&nbsp;</td>
                        <td align="left" valign="middle" class="narmal">Marital Status</td>
                        <td align="left" valign="middle">:</td>
                        <td colspan="4" align="left" valign="middle">
						
					<input type="radio"  name="st_maritalstatus" id="st_maritalstatus" <?php if($st_marital =="Married"){ echo "checked";}?> value="Married" />Married&nbsp;&nbsp;
						<input type="radio"  name="st_maritalstatus" id="st_maritalstatus" <?php if($st_marital =="Unmarried"){ echo "checked";}?> value="Unmarried" />Unmarried
						
						<?php /*?><input name="st_maritalstatus" type="text" id="st_maritalstatus" value="<?php if($st_marital!='') echo $st_marital; if(isset($es_staffList2->st_marital)&&$es_staffList2->st_marital!='') echo $es_staffList2->st_marital; ?>" /><?php */?>
					  ...
					  <tr>
                        <td>&nbsp;</td>
                        <td align="left" valign="middle" class="narmal">Experience</td>
                        <td align="left" valign="middle">:</td>
                        <td colspan="4" align="left" valign="middle">
																
					<input name="st_exp" type="text" id="st_exp" value="<?php if($st_experience!='') echo $st_experience; if(isset($es_staffList2->st_experience)&&$es_staffList2->st_experience!='') echo $es_staffList2->st_experience; ?>" />
						</td>
                      </tr>	
					  ...
					  <tr>
                        <td>&nbsp;</td>
                        <td align="left" valign="middle" class="narmal">Do You Belong to Reserved Category</td>
                        <td align="left" valign="middle">:</td>
                        <td colspan="4" align="left" valign="middle">
						
						<select name="st_categ" id="st_categ">
						...
						<?php /*?><input name="st_categ" type="text" id="st_categ" value="<?php if($st_category!='') echo $st_category; if(isset($es_staffList2->st_category)&&$es_staffList2->st_category!='') echo $es_staffList2->st_category; ?>" /><?php */?></td>
                  ...
                  <td align="center" class="narmal">
                    ...
                    <td align="left"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                                <tr>
                                     ...
                                     <td width="17%"><input name="st_doj2"  type="text" id="st_doj2" value="<?php  if($eachrecord1->st_dateofjoining!='') echo formatDBDateTOCalender($eachrecord1->st_dateofjoining);
									 ?>" readonly /><a href="javascript:void(0)" onclick="if(self.gfPop)gfPop.fPopCalendar(document.viewstaff.st_doj2);return false;" ><img src="<?php echo JS_PATH ?>/WeekPicker/calbtn.gif" alt="Calender" name="popcal" width="34" height="22" border="0" align="absmiddle" id="popcal" /></a></td>
                                </tr>
                           </table>
					   ...
					   <b><?php echo ucwords($eachrecord2->st_firstname ." ".$eachrecord2->st_lastname); ?></b><br/><b>Username</b> - <?php echo $eachrecord2->st_username; ?><br/><b>Password</b> - <?php echo $eachrecord2->st_password; ?></td>
                        ...
                        <td align="left" valign="middle" class="narmal"><?php if($eachrecord2->st_examp1!=""){echo strtoupper($eachrecord2->st_examp1); }
						 if($eachrecord2->st_examp2!=""){echo ", ".strtoupper($eachrecord2->st_examp2); }
						  ...
						  ?></td>
                          <td align="center" valign="middle" class="narmal"><?php echo formatDBDateTOCalender($eachrecord2->st_dob); ?></td>
