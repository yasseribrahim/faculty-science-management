...
/************ Get List of Districts ***********/
		...
		{   
			...
			url="?pid=120&action=getposts&es_departmentsid="+countryid+"&selval="+selval;
		...
		{   
			...
			url="?pid=120&action=getstaff&cid="+countryid+"&selval="+getselected;
			url=url+"&sid="+Math.random();
...
/*$sql="SELECT sno FROM es_bonafiedbank order by id desc limit 0,1";
		 $aac=$db->getrow($sql);
		$sno=$aac['id'];
		 $sno=$sno+1;
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
     ...
     <tr>
         <td height="3" colspan="3"></td>
              ...
              <tr>
                <td height="25" colspan="3" class="bgcolor_02">&nbsp;<span class="admin">Bonafied for Bank Account Certificate</span></td>
  </tr>	
                ...
                <td  align="center" valign="top">
				 ...
				 <form name="reg" action="" method="post" enctype="multipart/form-data">
				   ...
				   <table width="96%" height="52%" border="0" cellpadding="3px" cellspacing="0">
                     ...
                     <?php if($action!='edit'){?>
                     <tr><td colspan="3"><table width="120%">
<tr>
				<td width="37%" class="narmal"  align="left"> Branch </td>
...
<?php echo $html_obj->draw_hiddenfield('copyid',$copyid);?><?php */?>
			...
			<td width="1%" align="center"><strong> :</strong></td>
					<td width="64%" height="30" align="left"><input type="text" name="sno1" value="<?php if($action=='edit'){
                                 echo $sem_det['id']; } else {   $max_id=$db->getRow("SELECT MAX(id) as max_id FROM es_bonafiedbank");
              ...
              <tr>
				...
				<table width="100%" border="0">
				  ...
				  <tr>
					...
					<table width="100%" border="0">
						<tr>
						<td colspan="7" align="right" height="25" style="padding-right:20px;"><a href="?pid=120&action=add" class="bgcolor_02" style="padding:5px; text-decoration:none; color:#333333">Add New</a></td>
					  </tr>
					  <tr><td>&nbsp;</td></tr>
					 ...
					 ?>
					  ...
					  <tr>
						...
						<td align="left" valign="middle">&nbsp;<?php echo $eachrecord['father_name']; ?></td>
							...
							<a href="javascript:void(0)" onclick="popup_letter('?pid=120&action=print_bonafied_bankcertificate&id=<?php echo $eachrecord['id']; ?>')" ><img src="images/print_16.png" border="0" title="View" alt="View" /></a>
							
							
							&nbsp;<a href="?pid=120&action=edit&id=<?php echo $eachrecord['id']; ?>" ><img src="images/b_edit.png" border="0" title="Edit" alt="Edit" /></a><?php /*?>&nbsp;<a href="?pid=95&action=delete&id=<?php echo $eachrecord['id']; ?>" onClick="return confirm('Are you sure want to delete ?')"><img src="images/b_drop.png" border="0" title="Delete" alt="Delete" /></a><?php */?></td>
...
<?php }?>
<?php if($action=='print_bonafied_bankcertificate'){ 
									...
									<td height="30" colspan="4" align="left" valign="top" ><table width="100%" border="0" cellpadding="0" cellspacing="2" style="font-family:Verdana, Arial, Helvetica, sans-serif; font-size:14px; font-weight:500; line-height:25px;">
                                        ...
                                        <tr><td width="7105%" colspan="7"><table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
                                          ...
                                          <tr>
                                            ...
                                            <td colspan="3" align="left" valign="bottom" style="border-bottom:#999999 dotted 1px; font-family:Verdana, Arial, Helvetica, sans-serif; font-size:13px; color:#000000; font-weight:bold;">&nbsp;&nbsp;<?php echo $candidate_det['student_name']; ?></td>
                                          </tr>
                                          <tr>
                                            <td height="30" colspan="4" align="left" valign="bottom"><table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
                                                <tr>
                                                  ...
                                                  <td width="26%" align="left" valign="bottom" style="border-bottom:#999999 dotted 1px; font-family:Verdana, Arial, Helvetica, sans-serif; font-size:13px; color:#000000; font-weight:bold;"><?php echo ucwords($candidate_det['father_name']); ?></td>
                                                  <td width="58%" align="left" valign="bottom" style="font-family:Verdana, Arial, Helvetica, sans-serif; font-size:12px; color:#000000;">&nbsp;&nbsp;&nbsp;&nbsp;is a a bonafide Student of B.Tech./MBA/MCA  </td>
                                          ...
                                          <tr>
                                            <td height="30" colspan="4" align="left" valign="bottom"><table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
												...
												<td width="29%" align="left" valign="bottom" style="border-bottom:#999999 dotted 1px; font-family:Verdana, Arial, Helvetica, sans-serif; font-size:13px; color:#000000; font-weight:bold;">
                                                  ...
                                                  <td width="38%" align="left" valign="bottom" style="border-bottom:#999999 dotted 1px; font-family:Verdana, Arial, Helvetica, sans-serif; font-size:13px; color:#000000; font-weight:bold;"><?php echo $candidate_det['section']; ?></td>
                                                </tr>
                                            </table></td>
                                          </tr>
                                          <tr>
                                          ...
                                          <tr>
                                            <td colspan="4" align="left" valign="top"><table width="53%" border="0" cellspacing="0" cellpadding="0">
												...
												<table width="100%">
												 <tr>
                                                <td width="50%" height="30" align="left" valign="bottom" style="font-family:Verdana, Arial, Helvetica, sans-serif; font-size:12px; color:#000000;"> <br />Student's address as per our office record is;</td>                                        
                                                <td width="54%" valign="bottom" style="font-family:Verdana, Arial, Helvetica, sans-serif; font-size:13px; color:#000000;"><strong><?php /*echo $candidate_det['charector']; */?></strong><br /> </td>
 
                                              </tr>
											  <table width="100%">
									 <tr><th width="40%" align="center"><br />Present Address</th>
									 <th width="20%"></th>
									 <th width="40%" align="center"><br />Permanent Address</th>
									 </tr>
									 <tr>
									 <td width="40%" style="border-bottom:#999999 1px; border-right:thick #000000 1px; font-family:Verdana, Arial, Helvetica, sans-serif; font-size:13px; color:#000000; " align="left">
									 <?php 
									 $es_preadmissionid=$_GET['id'];
									 $student_t=$db->getRow("SELECT * FROM es_bonafiedbank WHERE id=".$es_preadmissionid);
									 echo $idd=$student_t['roll_number'];
									 $student_det1=$db->getRow("SELECT * FROM es_preadmission WHERE es_preadmissionid=".$idd);
									 echo $student_det1['pre_address1'];?>
                                     </td>
									 <td width="20%"></td>
									 <td width="40%" style="border-bottom:#999999  1px; font-family:Verdana, Arial, Helvetica, sans-serif; font-size:13px; color:#000000; " align="left">
									 <?php 
									 $es_preadmissionid=$_GET['id'];
									 $student_t=$db->getRow("SELECT * FROM es_bonafiedbank WHERE id=".$es_preadmissionid);
									 echo $idd=$student_t['roll_number'];
									 $student_det1=$db->getRow("SELECT * FROM es_preadmission WHERE es_preadmissionid=".$idd);
									 echo $student_det1['pre_address'];?>
									 </td>
